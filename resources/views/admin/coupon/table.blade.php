...
@section('admin')
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="page-title"><a href="{{ url()->current() }}">{{ __('admin.coupons') }}</a></h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($coupon->status == 'available')
                                        <span class="btn btn-sm round btn-outline-danger change-coupon-status"
                                            data-date="{{ $coupon->expire_date }}" data-status="closed"
                                            data-id="{{ $coupon->id }}">
                                    ...
                                    @else
                                        <span class="btn btn-sm round btn-outline-success open-coupon" data-toggle="modal"
                                            id="div_{{ $coupon->id }}" data-target="#notify"
                                            data-id="{{ $coupon->id }}">
                                ...
                                <td class="product-action">
                                    <span class="text-primary pr-1"><a
                                            href="{{ route('coupons.show', ['id' => $coupon->id]) }}"><i
                                                class="fa fa-eye"></i></a></span>
                                    <span class="action-edit text-primary pr-1"><a
                                            href="{{ route('coupons.edit', ['id' => $coupon->id]) }}"><i
                                                class="fa fa-edit"></i></a></span>
                                    <a class="text-danger" id="delete"
                                        href="{{ route('coupons.delete', $coupon->id) }}"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
