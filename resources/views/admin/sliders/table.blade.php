...
@section('title', __('admin.advertising_banners'))
...
@section('admin')
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="page-title"><a href="{{ url()->current() }}">{{ __('admin.advertising_banners') }}</a></h3>
                            ...
                            <tr>
                                ...
                                <td class="product-action">
                                    <span class="text-primary pr-1"><a
                                            href="{{ route('sliders.show', ['id' => $slider->id]) }}"><i
                                                class="fa fa-eye"></i></a></span>
                                    <span class="action-edit text-primary pr-1"><a
                                            href="{{ route('sliders.edit', ['id' => $slider->id]) }}"><i
                                                class="fa fa-edit"></i></a></span>
                                    <a class="text-danger" id="delete"
                                        href="{{ route('sliders.delete', $slider->id) }}"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
