                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group validate">
                            ...
                            <div class="controls">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Search" required="" aria-invalid="false">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="noChar" class="form-control" required="" data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="No Characters Allowed, Only Numbers" aria-invalid="false"> <div class="help-block"></div></div>
                        </div>
                        <div class="form-group">
