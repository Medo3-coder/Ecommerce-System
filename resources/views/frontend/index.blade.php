                                ...
                                <div class="products">
                                    ...
                                    <div class="product-info text-left m-t-20">
                                        ...
                                        <div class="product-price"> <span class="price"> {{ $product->selling_price }} </div>
                                            ...
                                            <div class="product-price"> <span class="price"> ${{ round($discountAmount) }} </span> <span
                    ...
                    <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                        <div class="more-info-tab clearfix ">
                            ...
                            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                               ...
                               @foreach ($categories as $category)
                                <li>
                                    <a data-transition-type="backSlide" href="#category{{ $category->id }}" data-toggle="tab">{{ $category->category_name_en }}</a>
                                </li>
                                @endforeach
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            ...
                                            @endphp
                                              ...
                                              <div class="tag hot"><span>{{ $discount_percentage }}%</span></div>
                                              @endif
                                        ...
                                        <div class="product-info text-left">
                                            ...
                                            @endif
                                            <div class="product-price"> <span class="price"> ${{ $discountAmount }} </span>
