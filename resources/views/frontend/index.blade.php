    ...
    <div class="body-content outer-top-xs" id="top-banner-and-menu">
        <div class="container">
            <div class="row">
                ...
                <!-- ============================================== PRODUCT TAGS ============================================== -->
               @include('frontend.common.product_tags', ['tags_en'=>$tags_en, 'tags_ar'=>$tags_ar, 'tags_hin'=>$tags_hin])
                            ...
                            <div class="tab-pane" id="category{{ $category->id }}">
                                <div class="product-slider">
                                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                        ...
                                        @php
                                            $category_wise_product = App\Models\Product::where('category_id', $category->id)
                                                ->orderBy('id', 'DESC')
                                                ->get();
                                        @endphp
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="add-cart-button btn-group">
                                                        <button class="btn btn-primary icon" data-toggle="dropdown"
                                                            type="button"> <i class="fa fa-shopping-cart" data-toggle="modal" data-target="#exampleModal" id="{{ $product->id }}" onclick="productView(this.id)">
                                                                </i> </button>
...
<!-- ============================================== skip_product_3 PRODUCTS ============================================== -->
<section class="section featured-product wow fadeInUp">
    <h3 class="section-title">


        @if (session()->get('language') == 'hindi')
        {{ $skip_category_3->category_name_hin }}
    @elseif (session()->get('language') == 'arabic')
        {{ $skip_category_3->category_name_ar }}
    @else
...
<!-- ============================================== skip_brand_Lenovo PRODUCTS ============================================== -->
<section class="section featured-product wow fadeInUp">
    <h3 class="section-title">


        @if (session()->get('language') == 'hindi')
        {{ $skip_brand_Lenovo->brand_name_en }}
    @elseif (session()->get('language') == 'arabic')
        {{ $skip_brand_Lenovo->brand_name_ar }}
    @else
        {{ $skip_brand_Lenovo->brand_name_en }}
    @endif
    </h3>
    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
        ...
        @foreach ($skip_product_Lenovo as $product)
            <div class="item item-carousel">
                <div class="products">
                    <div class="product">
                        <div class="product-image">
...
<!-- /.section -->
<!-- ================== skip_brand_Lenovo PRODUCTS : END ============================ -->
